...
מפרט Conventional Commits הוא מוסכמה קלה ליישום המתווספת להודעות commit.
הוא מספק מערכת פשוטה של כללים ליצירת היסטוריית commits מפורשת,
ובכך מקל על פיתוח כלים אוטומטיים העובדים מעליה.
המוסכמה משתלבת עם [SemVer](http://semver.org),
ומאפשרת לתאר תכונות חדשות, תיקונים ושינויים שוברים בהודעות commit.
